...
-- led	=>  Location: PIN_85,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 8mA
...
-- Equation(s):
-- \counter~1_combout\ = (\Add0~0_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \Equal0~5_combout\ = (!counter(17) & (counter(18) & (counter(19) & counter(16))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!counter(7) & (!counter(4) & (!counter(5) & counter(6))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!counter(1) & (!counter(0) & (!counter(3) & !counter(2))))
